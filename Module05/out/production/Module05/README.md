...
The first print statement will be "Alice", while the second print statement will return False because the person class hasn't overridden hashcode or compareTo.
